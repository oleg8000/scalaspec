...
/*
  ...
  val pathsFromStart = Level0.pathsFromStart
  println("Level0.pathsFromStart.length = " + pathsFromStart.length)
  ...
  */
  ...
  val pathsFromStart1 = Level1.pathsFromStart
  pathsFromStart1.foreach { case(b, m) => print(" " + m.length) }
  println()
  println("Level1.pathsFromStart.length = " + pathsFromStart1.length)
